...
class Municipio extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('estado, paisId', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, estado, paisId', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'sucursals' => array(self::HAS_MANY, 'Sucursal', 'municipioId'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'paisId' => 'Pais en donde se encuentra ubicada la ciudad',
		);
	}
